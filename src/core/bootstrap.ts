...
import { ArchiveDraftInvoice } from './invoices/application/commands/archive-draft-invoice/archive-draft-invoice.ts';
import { DraftDraftInvoice } from './invoices/application/commands/draft-draft-invoice/draft-draft-invoice.ts';
import { ProcessInvoice } from './invoices/application/commands/process-invoice/process-invoice.ts';
import { CancelInvoice } from './invoices/application/commands/cancel-invoice/cancel-invoice.ts';
import { PayInvoice } from './invoices/application/commands/pay-invoice/pay-invoice.ts';
import { GetInvoice } from './invoices/application/queries/get-invoice/get-invoice.ts';
import { CreateAuthflowPolicy } from './financial-authorization/application/commands/create-authflow-policy.ts';
...
import {
    OnInvoiceProcessing,
    PollingConfig,
} from './invoice-paypal-transaction/on-invoice-processing.event-handler.ts';
...
export type Core = Awaited<ReturnType<typeof bootstrap>>;
