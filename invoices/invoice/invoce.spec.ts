...
describe('Invoice', () => {
    it('should create an invoice instance', () => {
        ...
        expect(invoice.total.equals(Money.create('130', 'USD').unwrap())).toBe(
            true
        );
        expect(
            invoice.lineItems.subtotal.equals(
                Money.create('130', 'USD').unwrap()
            )
        ).toBe(true);
        expect(invoice.vatRate.equals(Vat.create('0').unwrap())).toBe(true);
        expect(
            invoice.vatAmount.equals(Money.create('0', 'USD').unwrap())
        ).toBe(true);
    ...
    it('should apply VAT to invoice total', () => {
        ...
        expect(invoice.total.equals(Money.create('156', 'USD').unwrap())).toBe(
            true
        );
        expect(
            invoice.lineItems.subtotal.equals(
        ...
        expect(
            invoice.vatAmount.equals(Money.create('26', 'USD').unwrap())
        ).toBe(true);
    ...
    it('should reapply VAT to invoice total', () => {
        ...
        expect(invoice.total.equals(Money.create('143', 'USD').unwrap())).toBe(
            true
        );
        expect(
            invoice.lineItems.subtotal.equals(
        ...
        expect(
            invoice.vatAmount.equals(Money.create('13', 'USD').unwrap())
        ).toBe(true);
    });
    ...
    it('should add respect applied vat when a line item added', () => {
        ...
        expect(invoice.total.equals(Money.create('242', 'USD').unwrap())).toBe(
            true
        );
    });
    ...
    it('should remove a line item', () => {
        ...
        expect(invoice.lineItems.contains(lineItem2)).toBeTruthy();
    });
    ...
    it('should change total when a line item is removed', () => {
        ...
        expect(invoice.total.equals(Money.create('200', 'USD').unwrap())).toBe(
            true
        );
    });
